...
for(des of got.houses[1].people){
...
for(des of got.houses[1].people){
  console.log(`I am ${des.name} and my bio is ${des.description}`)
}
...
let obj = {Starks : got.houses[0].people.length , Lannisters: got.houses[1].people.length};
